    ...
    talents: defineTalentTree("Blades", [
        {
            ...
            prerequisites: [],
            benefits: [
                [{value: 5, desc: "+{0}% Attack Speed with Knives", category: "Melee_Weapon"}],
                [{value: 10, desc: "+{0}% Attack Speed with Knives", category: "Melee_Weapon"}],
                [{value: 15, desc: "+{0}% Attack Speed with Knives", category: "Melee_Weapon"}],
            ],
            position: [0, 5],
        ...
        },
        {
            ...
            benefits: [
                ...
                [{value: 10, desc: "+{0}% Damage with Knives", category: "Melee_DMG"}],
                [{value: 15, desc: "+{0}% Damage with Knives", category: "Melee_DMG"}],
            ],
            position: [1, 5],
        ...
        },
        {
            ...
            benefits: [
                [{value: 10, desc: "+{0}% Critical Damage with Knives", category: "Generic_Damage"}],
                [{value: 20, desc: "+{0}% Critical Damage with Knives", category: "Generic_Damage"}],
                [{value: 30, desc: "+{0}% Critical Damage with Knives", category: "Generic_Damage"}],
            ],
            position: [3, 5],
        ...
        },
        {
            ...
            prerequisites: [],
            benefits: [
                [{value: 10, desc: "+{0}% Aim Speed with Knives", category: "Ranged_Weapon"}],
                [{value: 15, desc: "+{0}% Aim Speed with Knives", category: "Ranged_Weapon"}],
                [{value: 20, desc: "+{0}% Aim Speed with Knives", category: "Ranged_Weapon"}],
            ],
            position: [0, 1],
        ...
        },
        {
            ...
            benefits: [
                [{value: 5, desc: "+{0}% Damage with Thrown Knives", category: "Ranged_DMG"}],
                [{value: 8, desc: "+{0}% Damage with Thrown Knives", category: "Ranged_DMG"}],
                [{value: 10, desc: "+{0}% Damage with Thrown Knives", category: "Ranged_DMG"}],
            ],
            position: [3, 1],
        ...
        },
        {
            ...
            benefits: [
                [{value: 100, desc: "{0}% Chance for Thrown Knife Critical Hits to Immobilise Targets", category: "Ranged_Weapon"}],
            ],
            position: [8, 5],
        ...
        },
        {
            ...
            benefits: [
                [{value: 10, desc: "+{0}% Damage with Thrown Knives", category: "Ranged_DMG"}],
                [{value: 15, desc: "+{0}% Damage with Thrown Knives", category: "Ranged_DMG"}],
                [{value: 20, desc: "+{0}% Damage with Thrown Knives", category: "Ranged_DMG"}],
            ],
            position: [4, 1],
