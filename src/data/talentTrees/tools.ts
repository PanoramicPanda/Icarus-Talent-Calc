...
export const toolsTree = {
    talents: defineTalentTree("Tools", [
        ...
        },
        {
            ...
            benefits: [
                [{value: 5, desc: "+{0}% Attack Speed with Pickaxes", category: "Melee_Weapon"}],
                [{value: 10, desc: "+{0}% Attack Speed with Pickaxes", category: "Melee_Weapon"}],
                [{value: 20, desc: "+{0}% Attack Speed with Pickaxes", category: "Melee_Weapon"}],
            ],
            position: [1, 1],
        ...
        },
        {
            ...
            benefits: [
                [{value: 20, desc: "+{0}% Pickaxe Melee Damage", category: "Melee_DMG"}],
                [{value: 40, desc: "+{0}% Pickaxe Melee Damage", category: "Melee_DMG"}],
                [{value: 60, desc: "+{0}% Pickaxe Melee Damage", category: "Melee_DMG"}],
            ],
            position: [1, 0],
        ...
        },
        {
            ...
            benefits: [
                [{value: 5, desc: "+{0}% Attack Speed with Axes", category: "Melee_Weapon"}],
                [{value: 10, desc: "+{0}% Attack Speed with Axes", category: "Melee_Weapon"}],
                [{value: 20, desc: "+{0}% Attack Speed with Axes", category: "Melee_Weapon"}],
            ],
            position: [1, 3],
        ...
        },
        {
            ...
            benefits: [
                [{value: 150, desc: "+{0}% Axe Melee Damage", category: "Melee_DMG"}, {value: 10, desc: "+{0}% Attack Speed with Axes", category: "Melee_Weapon"}, {value: 50, desc: "+{0}% Stamina Consumed by Axe Actions", category: "Stamina"}, {value: 100, desc: "+{0}% Wear Rate of Axes", category: "Item"}],
            ],
            position: [4, 3],
